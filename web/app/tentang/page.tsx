  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-12 py-5 bg-[#0E2C27]/80 backdrop-blur-md shadow-sm text-white">
      ...
      <nav className="flex gap-8 text-sm font-medium">
        ...
        {/* Tandai 'Tentang' sebagai link aktif */}
        ...
        <Link href="/dokumentasi-api" className="hover:text-[#f0c94e]">Dokumentasi API</Link>
      </nav>
    </header>
  );
}
    ...
    <main className="min-h-screen bg-[#0f271f] text-[#ffffff]">
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-28 px-4 md:py-40 bg-linear-to-b from-[#0f1f19] via-[#14271f] to-[#0f1f19]">
        ...
        <div className="absolute inset-0 z-0 opacity-20" style={{
            backgroundImage: `radial-gradient(at 50% 50%, #f0c94e 0%, transparent 70%)`,
        }}></div>
      ...
      {/* Visi & Misi Section (style dari file 2) */}
      <section className="bg-[#0f271f] py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="bg-[#10261e] border-none text-[#dfe7d6] p-6 flex flex-col items-start shadow-lg">
      ...
      {/* Teknologi yang Kami Gunakan Section (style dari file 2) */}
      ...
      <section className="bg-[#0f271f] py-16 px-4 text-center">
        <div className="container mx-auto max-w-3xl">
          ...
          <Button className="bg-[#f0c94e] text-black hover:bg-[#f0c94e]/90 text-lg px-8 py-6 rounded-md transition-colors font-semibold">
            Mulai Sekarang
          </Button>
        </div>
      </section>
