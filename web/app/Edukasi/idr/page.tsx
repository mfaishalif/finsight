...
export default function CurrencyDetailPage() {
  const currency = currencyDetails.idr;
...
const MoneyGroup = ({ title, items, currency, note = true }: any) => (
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-6">
    <h3 className="text-xl font-semibold mb-4 text-white pb-2 col-span-full flex items-center gap-2">{title}</h3>
...
const currencyDetails = {
  idr: {
    ...
    country: "Indonesia",
    paperNotes: [
      { value: "100.000", image: "/currencies/idr/375px-Indonesia_2016_100000r_o.jpg" },
      { value: "75.000", image: "/currencies/idr/Indonesian_75000_Rupiah_2020,_Obverse.jpg" },
      { value: "50.000", image: "/currencies/idr/375px-Indonesia_2016_50000r_o.jpg" },
      { value: "20.000", image: "/currencies/idr/375px-Indonesia_2016_20000r_o.jpg" },
      { value: "10.000", image: "/currencies/idr/375px-Indonesia_2016_10000r_o.jpg" },
      { value: "5.000", image: "/currencies/idr/Indonesia_2016_5000r_o.jpg" },
      { value: "2.000", image: "/currencies/idr/Indonesia_2016_2000r_o.jpg" },
      { value: "1.000", image: "/currencies/idr/Indonesia_2016_1000r_o.jpg" },
    ],
    coins: [
      { value: "100", image: "/currencies/idr/100_Rupiah_Indonesian.png" },
      { value: "200", image: "/currencies/idr/200_Rupiah_Indonesian.png" },
      { value: "500", image: "/currencies/idr/IDR_500_coin_2016.png" },
      { value: "1000", image: "/currencies/idr/IDR_1000_coin_2016.png" },
    ],
  },
};